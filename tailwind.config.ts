...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        soft: "0 4px 20px -2px rgba(10, 77, 140, 0.08)",
        card: "0 8px 30px -4px rgba(10, 77, 140, 0.12)",
        "card-hover": "0 12px 40px -4px rgba(10, 77, 140, 0.18)",
      },
      keyframes: {
        "accordion-down": {
          from: { height: "0" },
      ...
      animation: {
        ...
        "riseOnce": 'riseOnce 1s ease-out forwards',
      },
    },
  },
