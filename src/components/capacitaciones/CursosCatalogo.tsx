...
import { Calendar, Clock, Monitor, BookOpen, ArrowUpRight, Filter, Flame, GraduationCap, Timer, Sparkles } from "lucide-react";
...
const cursosData: Curso[] = [
  {
    id: 1,
    titulo: "Fundamentos de Metrología Aplicada al Laboratorio",
    categoria: "Metrología",
    modalidad: "Sincrónico",
    estado: "Por iniciar",
    fecha_inicio: "2026-04-25",
    duracion: "4 semanas",
    descripcion: "Curso enfocado en principios de medición, trazabilidad, incertidumbre y calibración en entornos de laboratorio.",
    badge: "Próximo inicio",
  },
  {
    id: 2,
    titulo: "Gestión de Calidad en Laboratorios ISO 17025",
    categoria: "Calidad",
    modalidad: "Asincrónico",
    estado: "En curso",
    fecha_inicio: "2026-04-10",
    duracion: "6 semanas",
    descripcion: "Implementación de sistemas de gestión de calidad y cumplimiento normativo bajo ISO 17025.",
    badge: "Más solicitado",
  },
  {
    id: 3,
    titulo: "Auditoría Interna para Laboratorios",
    categoria: "Auditoría",
    modalidad: "Sincrónico",
    estado: "Finalizado",
    fecha_inicio: "2026-03-01",
    duracion: "3 semanas",
    descripcion: "Formación en auditorías internas, hallazgos, acciones correctivas y mejora continua.",
    badge: "Curso finalizado",
  },
  {
    id: 4,
    titulo: "Validación de Métodos Analíticos",
    categoria: "Validación de métodos",
    modalidad: "Sincrónico",
    estado: "Por iniciar",
    fecha_inicio: "2026-05-12",
    duracion: "5 semanas",
    descripcion: "Metodología para validar procedimientos analíticos según estándares internacionales y criterios de aceptación.",
    badge: "Nuevo curso",
  },
  {
    id: 5,
    titulo: "Estimación de Incertidumbre de Medición",
    categoria: "Metrología",
    modalidad: "Asincrónico",
    estado: "En curso",
    fecha_inicio: "2026-04-05",
    duracion: "4 semanas",
    descripcion: "Cálculo y expresión de la incertidumbre de medición aplicando la guía GUM y métodos estadísticos.",
    badge: "Últimos cupos",
  },
  {
    id: 6,
    titulo: "Interpretación y Aplicación de la Norma ISO 17025:2017",
    categoria: "ISO 17025",
    modalidad: "Sincrónico",
    estado: "Por iniciar",
    fecha_inicio: "2026-05-20",
    duracion: "3 semanas",
    descripcion: "Análisis detallado de los requisitos de la norma ISO/IEC 17025:2017 y su implementación práctica.",
    badge: "Próximo inicio",
  },
  {
    id: 7,
    titulo: "Control de Calidad Analítico y Cartas de Control",
    categoria: "Calidad",
    modalidad: "Asincrónico",
    estado: "Por iniciar",
    fecha_inicio: "2026-06-01",
    duracion: "4 semanas",
    descripcion: "Herramientas estadísticas para el control de calidad analítico: cartas de control, ensayos de aptitud y materiales de referencia.",
    badge: "Nuevo curso",
  },
  {
    id: 8,
    titulo: "Gestión de No Conformidades y Acciones Correctivas",
    categoria: "Auditoría",
    modalidad: "Sincrónico",
    estado: "Finalizado",
    fecha_inicio: "2026-02-15",
    duracion: "2 semanas",
    descripcion: "Identificación, tratamiento y seguimiento de no conformidades con enfoque en análisis de causa raíz.",
    badge: "Curso finalizado",
  },
];
    ...
    <div>
      ...
      <div className="bg-card rounded-2xl p-6 border border-border shadow-sm mb-8">
        <div className="flex items-center gap-2 mb-4">
          ...
          <h4 className="font-semibold text-foreground">Filtrar cursos</h4>
          {hasFilters && (
            <button
        ...
        <div className="space-y-4">
          {/* Estado */}
          <div>
            <span className="text-xs font-semibold text-muted-foreground uppercase tracking-wider mb-2 block">Estado</span>
            <div className="flex flex-wrap gap-2">
              {allEstados.map((e) => (
                <FilterButton key={e} label={e} active={filtroEstado === e} onClick={() => setFiltroEstado(filtroEstado === e ? null : e)} />
              ))}
            </div>
          </div>
          ...
          {/* Modalidad */}
          <div>
            <span className="text-xs font-semibold text-muted-foreground uppercase tracking-wider mb-2 block">Modalidad</span>
            <div className="flex flex-wrap gap-2">
              {allModalidades.map((m) => (
                <FilterButton key={m} label={m} active={filtroModalidad === m} onClick={() => setFiltroModalidad(filtroModalidad === m ? null : m)} />
              ))}
            </div>
          </div>
          ...
          {/* Categoría */}
          <div>
            <span className="text-xs font-semibold text-muted-foreground uppercase tracking-wider mb-2 block">Categoría</span>
            <div className="flex flex-wrap gap-2">
              {allCategorias.map((cat) => (
                <FilterButton key={cat} label={cat} active={filtroCategoria === cat} onClick={() => setFiltroCategoria(filtroCategoria === cat ? null : cat)} />
              ))}
            </div>
          </div>
        </div>
      ...
      <div className="flex items-center justify-between mb-6">
        <p className="text-muted-foreground text-sm">
          Mostrando <span className="font-semibold text-foreground">{cursosFiltrados.length}</span> de {cursosData.length} cursos
        </p>
      </div>
