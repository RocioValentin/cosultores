...
const cursosData: Curso[] = [
  ...
  { id: 2, titulo: "Gestión de Calidad en Laboratorios ISO 17025", categoria: "Calibración", modalidad: "Asincrónico", estado: "En curso", fecha_inicio: "2026-04-10", duracion: "6 semanas", descripcion: "Implementación de sistemas de gestión de calidad y cumplimiento normativo bajo ISO 17025.", badge: "Más solicitado" },
  { id: 3, titulo: "Auditoría Interna para Laboratorios", categoria: "Análisis Instrumental", modalidad: "Sincrónico", estado: "Finalizado", fecha_inicio: "2026-03-01", duracion: "3 semanas", descripcion: "Formación en auditorías internas, hallazgos, acciones correctivas y mejora continua.", badge: "Curso finalizado" },
  { id: 4, titulo: "Validación de Métodos Analíticos", categoria: "Calidad ISO 17025", modalidad: "Sincrónico", estado: "Por iniciar", fecha_inicio: "2026-05-12", duracion: "5 semanas", descripcion: "Metodología para validar procedimientos analíticos según estándares internacionales y criterios de aceptación.", badge: "Nuevo curso" },
  ...
  { id: 6, titulo: "Interpretación y Aplicación de la Norma ISO 17025:2017", categoria: "Calidad ISO 17025", modalidad: "Sincrónico", estado: "Por iniciar", fecha_inicio: "2026-05-20", duracion: "3 semanas", descripcion: "Análisis detallado de los requisitos de la norma ISO/IEC 17025:2017 y su implementación práctica.", badge: "Próximo inicio" },
  { id: 7, titulo: "Control de Calidad Analítico y Cartas de Control", categoria: "Ensayos Químicos", modalidad: "Asincrónico", estado: "Por iniciar", fecha_inicio: "2026-06-01", duracion: "4 semanas", descripcion: "Herramientas estadísticas para el control de calidad analítico: cartas de control, ensayos de aptitud y materiales de referencia.", badge: "Nuevo curso" },
  { id: 8, titulo: "Gestión de No Conformidades y Acciones Correctivas", categoria: "Calidad ISO 17025", modalidad: "Sincrónico", estado: "Finalizado", fecha_inicio: "2026-02-15", duracion: "2 semanas", descripcion: "Identificación, tratamiento y seguimiento de no conformidades con enfoque en análisis de causa raíz.", badge: "Curso finalizado" },
];
